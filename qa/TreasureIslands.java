...
Space complexity: O(r * c). since at worst case, we need to hold all the vertices in the queue.
     */
    ...
    private static boolean canReach(char[][] grid, int r, int c) {
